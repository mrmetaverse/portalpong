...
export const CHARACTERS: Record<CharacterType, CharacterDef> = {
  ...
  knight: {
    ...
    strongAgainst: ['berserker', 'sage'],
    weakAgainst: ['wizard', 'rogue'],
    themeColor: '#94a3b8',
    accentColor: '#38bdf8',
  ...
  rogue: {
    ...
    strongAgainst: ['wizard', 'knight'],
    weakAgainst: ['witch', 'sage'],
    themeColor: '#a855f7',
    accentColor: '#2dd4bf',
  ...
  berserker: {
    ...
    strongAgainst: ['witch', 'sage'],
    weakAgainst: ['wizard', 'knight'],
    themeColor: '#ef4444',
    accentColor: '#f97316',
